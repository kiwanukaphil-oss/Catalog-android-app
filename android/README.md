...
Signed distribution, production use, AI review, matching, pricing, receiving and stock lookup remain later phases under the owner's confirmation policy. See the [screen specification](../docs/android-screen-flow.md) and [API contract](../docs/android-api-contract.md).
